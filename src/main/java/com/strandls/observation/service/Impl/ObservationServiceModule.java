...
public class ObservationServiceModule extends AbstractModule {
	...
	protected void configure() {
		...
		bind(ObservationDataTableService.class).to(ObservationDataTableServiceImpl.class).in(Scopes.SINGLETON);
		bind(ObservationCreateService.class).to(ObservationCreateServiceImpl.class).in(Scopes.SINGLETON);
