...
public enum ObservationIndex {
	...
	district("location_information.district.raw"), rank("max_voted_reco.ranktext.keyword"),
	...
	geoEntity("location_information.name.raw"),recoId("all_reco_vote.recommendation_id"), publicationgrade("is_publication_grade"),dataSetName("dataset_title"),dataTableName("data_table_title");
