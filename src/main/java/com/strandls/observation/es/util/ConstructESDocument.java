...
public class ConstructESDocument {
	...
	public List<ObservationESDocument> getESDocumentStub(String observationId) {
		...
		String qry = "SELECT id observation_id, author_id, created_by, profile_pic, created_on, group_id, group_name, CONCAT(group_id,'|',group_name,'|',group_order) sgroup_filter, "
				...
				+ "  (taxon_detail->'status') AS taxonstatus,italicised_form "
				...
				+ "(reco_vote->> 'italicised_form')::text as italicised_form,  " + "CASE "
				...
				+ "		MAX(accepted_name_id)accepted_name_id,	sum(Count) Count,MAX(italicised_form)italicised_form        	 "
				+ "	FROM  " + "	(SELECT "
				+ "	observation_id, recommendation_id, common_name_reco_id, Count, italicised_form,  "
