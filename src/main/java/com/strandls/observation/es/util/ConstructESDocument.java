...
public class ConstructESDocument {
	...
	public ObservationESDocument getESDocumentStub(String observationId) {
		...
		String qry = "SELECT id observation_id, author_id, created_by, profile_pic, created_on, group_id, group_name, CONCAT(group_id,'|',group_name) sgroup_filter, "
				...
				+ "observation_id, " + "jsonb_array_elements(maybe_max_voted) reco_vote, " + "all_reco_vote " + "FROM "
				...
				+ "		FROM  "
				+ "		(SELECT id, observation_id, author_id , confidence, recommendation_id, common_name_reco_id, voted_on, comment,comment, 1::integer AS Count "
				...
				+ "			WHEN is_scientific_name = false or recommendation_id = common_name_reco_id THEN recommendation_name "
				+ "			ELSE NULL "
				+ "			END AS common_name, language_id, is_scientific_name, accepted_name_id, Count " + "		FROM  "
				+ "		(SELECT  "
